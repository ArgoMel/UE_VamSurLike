...
#include "../../Public/AI/CoreDawnPawn.h"

ACoreDawnPawn::ACoreDawnPawn()
{
...
void ACoreDawnPawn::OnConstruction(const FTransform& Transform)
{
	Super::OnConstruction(Transform);
}

void ACoreDawnPawn::BeginPlay()
{
	Super::BeginPlay();
}

void ACoreDawnPawn::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	Super::EndPlay(EndPlayReason);
}

void ACoreDawnPawn::Tick(float DeltaTime)
{
